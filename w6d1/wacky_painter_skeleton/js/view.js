...
View.prototype.exercise3 = function () {
  ...
  const $love = $('<br><h1>i love jquery</li>');
  const $last = $('ul:last-of-type');
  $last.append($love);
};
...
View.prototype.exercise4 = function () {
  ...
  const $evOther = $('li:nth-of-type(2n)');
  $evOther.text("CP");
};
...
View.prototype.exercise5 = function () {
  ...
  $li.on("click", function (event) {
    ...
    let clickedSquare = event.toElement;
    let $clSquare = $(clickedSquare);
    let pos = $clSquare.attr('data-pos');
    alert(pos);
  });
};
